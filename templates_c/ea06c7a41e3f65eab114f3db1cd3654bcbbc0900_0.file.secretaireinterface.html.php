<?php
/* Smarty version 3.1.30, created on 2019-08-26 00:54:03
  from "C:\xampp\htdocs\KayFadiou\src\view\welcome\secretaireinterface.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5d63118b6569b2_09929408',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ea06c7a41e3f65eab114f3db1cd3654bcbbc0900' => 
    array (
      0 => 'C:\\xampp\\htdocs\\KayFadiou\\src\\view\\welcome\\secretaireinterface.html',
      1 => 1566773478,
      2 => 'file',
    ),
  ),
...
function content_5d63118b6569b2_09929408 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="fr">
...
Patient/add"> <i class="fa fa-plus"></i> Ajouter un patient
								</a>
							</div>
						</div>
...
?>
									...
									<tr >
										...
										<td><?php echo $_smarty_tpl->tpl_vars['patient']->value['nom_Pat'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['patient']->value['prenom_pat'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['patient']->value['addr_pat'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['patient']->value['tel_pat'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['patient']->value['sexe_pat'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['patient']->value['age_pat'];?>
</td>
										<td><?php echo $_smarty_tpl->tpl_vars['patient']->value['profession'];?>
</td>

										<td>
											<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#ordine"><i class="fa fa-pencil"></i>
											</button>
												<a  type="button" class="btn btn-danger btn-xs" href="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
Patient/delete/<?php echo $_smarty_tpl->tpl_vars['patient']->value['id'];?>
">
				...
				<div class="modal-content ">
					...
					<div class="modal-body">
						<div class="panel panel-bd lobidrag">
							<div class="panel-heading">
								<div class="btn-group">
									<a class="btn btn-primary" href="#"> <i class="fa fa-list"></i>  Retour vers la liste </a>
								</div>
							</div>
							<div class="panel-body">

								<form class="col-sm-12" method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_base']->value;?>
Patient/update">
									<div class="form-group"><label class="control-label">Id Patient</label>
										<input class="form-control" readonly type="hidden" name="id" id="id" value="<?php if (isset($_smarty_tpl->tpl_vars['patient']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['patient']->value['id'];?>
 <?php }?>"/>
									</div>
									<div class="row">
										<!-- Form controls -->
										<div class="col-sm-12">
											<fieldset class="col-sm-6" >
												<div class="form-group">
													...
													<label>Nom</label>
													<input name="nom_Pat" type="text" class="form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['patient']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['patient']->value['nom_Pat'];?>
 <?php }?>">
												</div>
												<div class="form-group">
													<label>Prenom</label>
													<input name="prenom_pat" type="text" class="form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['patient']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['patient']->value['prenom_pat'];?>
 <?php }?>" >
												</div>
												...
												<div class="form-group">
													<label>Age</label>
													<input name="age_pat" type="text" class="form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['patient']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['patient']->value['age_pat'];?>
 <?php }?>">
												</div>
											...
											<fieldset class="col-sm-6" >
												...
												<div class="form-group">
													<label>Adresse</label>
													<input type="text" class="form-control" rows="3" name="addr_pat" value="<?php if (isset($_smarty_tpl->tpl_vars['patient']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['patient']->value['addr_pat'];?>
 <?php }?>"/>

												</div>
												<div class="form-group">
													<label>Telephone</label>
													<input name="tel_pat" type="text" class="form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['patient']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['patient']->value['tel_pat'];?>
 <?php }?>">
												</div>
												<div class="form-group">
													<label>Profession</label>
													<input name="profession" type="text" class="form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['patient']->value)) {?> <?php echo $_smarty_tpl->tpl_vars['patient']->value['profession'];?>
 <?php }?>">
												</div>
