<?php
/* Smarty version 3.1.30, created on 2019-08-25 10:47:52
  from "C:\xampp\htdocs\KayFadiou\src\view\ordonance\add.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5d624b38d20025_58697685',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd0ffacd6047642a52f6e68c970a0b54383b6a58c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\KayFadiou\\src\\view\\ordonance\\add.html',
      1 => 1566722871,
      2 => 'file',
    ),
  ),
...
function content_5d624b38d20025_58697685 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="fr">
...
Ordonance/liste">
									<i class="fa fa-list"></i>  Liste des ordonances </a>
							</div>
						</div>
										...
										<div class="col-sm-12">
											<fieldset class="col-sm-6" >
												<div class="form-group">
													...
													<label>Titre</label>
													<input name="titre" type="text" class="form-control" placeholder="Saisir titre" required>
												</div>
												<div class="form-group">
													<label>Date</label>
													<input name="dateo" type="text" class="form-control" placeholder="Saisir la date" required>
												</div>

												<div class="form-group">
													<label>Observation</label>
													<input name="observation" type="text" class="form-control" placeholder="Observation..." required>
												</div>
											...
											<fieldset class="col-sm-6" >
												...
												<div class="form-group">
													...
													<input name="traitement" type="text" class="form-control" placeholder="Traitement..." required>

												</div>

												<div class="form-group">
													<label class="control-label">Consultation</label>
													<?php if (isset($_smarty_tpl->tpl_vars['consultations']->value)) {?>
													<select name="idconsultation" class="form-control" required>
...
?>
														...
														<option value="<?php echo $_smarty_tpl->tpl_vars['consultation']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['consultation']->value['id'];?>
</option>
